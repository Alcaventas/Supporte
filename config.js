...
global.prefa = ['', '!', '.', ',', '🐤', '🗿'];
global.owner = ['528246200244'];
global.ownMain = '528246200244';
global.NamaOwner = ' 𝗔𝗟𝗖𝗔 𝚩𝐔𝐆'; // Do not change 
global.sessionName = 'session';
global.connect = true; // Set to false if using QR Code
global.namabot = '𝗔𝗟𝗖𝗔 𝚩𝐔𝐆'; // Do not change
global.author = '𝗔𝗟𝗖𝗔 𝚩𝐔𝐆'; // Do not change
global.packname = '𝗔𝗟𝗖𝗔  🚹'; // Change if needed
